...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { B[0] }]; #IO_L19N_T3_VREF_35 Sch=B[0]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { B[1] }]; #IO_L24P_T3_34 Sch=B[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { A[0] }]; #IO_L4N_T0_34 Sch=A[0]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { A[1] }]; #IO_L9P_T1_DQS_34 Sch=A[1]


##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { C_in }]; #IO_L12N_T1_MRCC_35 Sch=C_in
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { Sum[0] }]; #IO_L23P_T3_35 Sch=Sum[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { Sum[1] }]; #IO_L23N_T3_35 Sch=Sum[1]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { C_out }]; #IO_0_35 Sch=C_out
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { compare_result[2] }]; #IO_L18P_T2_34 Sch=compare_result[0]
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { compare_result[1] }]; #IO_L6N_T0_VREF_35 Sch=compare_result[1]
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { compare_result[0] }]; #IO_L8P_T1_AD10P_35 Sch=compare_result[2]
